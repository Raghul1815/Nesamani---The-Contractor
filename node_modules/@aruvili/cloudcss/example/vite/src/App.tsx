    ...
    <div className="min-h-screen bg-[#040404] text-white font-sans overflow-x-hidden flex flex-col items-center justify-center p-8">
      ...
      <main className="flex flex-col items-center text-center max-w-4xl relative">
        ...
        <div className="flex items-center gap-10 mb-12 group">
          ...
          <div className="relative cursor-pointer">
            ...
            <div className="w-32 h-32 rounded-[2.5rem] bg-white/5 border border-white/10 flex items-center justify-center transform group-hover:scale-110 group-hover:-rotate-12 transition-all duration-1000 relative z-10 select-none overflow-hidden">
              <img src={cloudcssLogo} alt="cloudCSS Logo" className="w-24 h-24 object-contain" />
            </div>
          </div>
          ...
          {/* Vite Logo */}
          <div className="relative cursor-pointer">
            <div className="absolute -inset-8 bg-blue-500/20 blur-[80px] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-1000"></div>
            <div className="w-32 h-32 flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-1000 relative z-10">
              <img src={viteLogo} alt="Vite Logo" className="w-24 h-24 object-contain" />
            </div>
          </div>
          ...
          {/* React Logo */}
          <div className="relative cursor-pointer">
            <div className="absolute -inset-8 bg-blue-400/20 blur-[80px] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-1000"></div>
            <div className="w-32 h-32 flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-1000 relative z-10">
              <img src={reactLogo} alt="React Logo" className="w-24 h-24 object-contain" />
            </div>
          </div>
        </div>
        ...
        <p className="text-2xl text-[#a1a1aa] font-bold tracking-tight max-w-2xl leading-tight opacity-80 mb-12">
          The high-performance UI engine for <span className="text-white border-b-4 border-blue-500">Vite + React</span>.
          Utility-first styling perfected by <span className="text-white">cloudCSS</span>.
        </p>

        {/* Scaled Starter Actions */}
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="#" className="px-12 py-4 bg-[#b6f09c] text-black font-black uppercase tracking-tighter text-xl rounded-2xl hover:bg-white hover:scale-105 transition-all shadow-[0_20px_40px_rgba(182,240,156,0.2)] active:scale-95 cursor-pointer">
            Documentation
          </a>
          <a href="https://github.com/Aruvili/cloudcss" target="_blank" rel="noopener noreferrer" className="px-12 py-4 bg-white/5 border border-white/10 text-white font-black uppercase tracking-tighter text-xl rounded-2xl hover:bg-white/10 transition-all active:scale-95 cursor-pointer flex items-center gap-4">
            GitHub
          </a>
        </div>
